...
function loadPage(page) {
  ...
  if (page === 'home') {
    main.innerHTML = `
      <section class="home">
        <h1>Welcome to <span style="color:#ff6600;">Shopping Kart</span></h1>
        <p>Your one-stop shop for the latest <b>electronics</b> and <b>gadgets</b>.<br>
        <span style="color:#008080;">Enjoy exclusive deals and fast delivery!</span></p>
        <img src="https://static.vecteezy.com/system/resources/previews/034/962/559/non_2x/banner-with-3d-empty-shopping-cart-color-advertising-of-shops-and-services-vector.jpg" alt="Banner" style="width:100%;max-width:600px;border-radius:16px;margin:1.5rem 0;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
      </section>
    `;
    ...
    main.innerHTML = `
      <section class="about">
        ...
        <ul>
          ...
          <li>Contact: support@shoppingkart.com</li>
        </ul>
      </section>
    `;
    ...
    main.innerHTML = `
      <section class="contact">
        ...
        <form onsubmit="event.preventDefault();alert('Thank you for contacting us!');">
          <input type="text" placeholder="Your Name" required style="display:block;margin-bottom:0.5rem;width:100%;max-width:300px;">
          <input type="email" placeholder="Your Email" required style="display:block;margin-bottom:0.5rem;width:100%;max-width:300px;">
          <textarea placeholder="Your Message" required style="display:block;margin-bottom:0.5rem;width:100%;max-width:300px;"></textarea>
          <button type="submit" style="background:#ff6600;color:#fff;border:none;padding:0.5rem 1.5rem;border-radius:4px;cursor:pointer;">Send</button>
        </form>
      </section>
    `;
  }
